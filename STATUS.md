...
_Updated 2026-08-13: #7, #8 (research flagships), and #9 (literal ENC-COAX, natively incl. exact curved CAD surfaces) are now **DONE**. Remaining below is #11 (perf-only) and #12 (external HFSS campaign)._
| # | item | status | blocker |
|---|---|---|---|
