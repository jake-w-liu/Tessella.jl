...
cylinder, Boolean, NURBS/IGES, classified Point/Line-In-Surface MSH4 projection,
native `.geo`, projected MSH2/MSH4 single-/two-direction periodic surfaces,
compact periodic node pairs, and 2-D boundary-layer parity cases.
