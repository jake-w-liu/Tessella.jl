...
order for complete element-sized groups. Higher orders, non-simplex families,
quadrature-rule queries, entity-filtered orientation/key results, and nondefault task
