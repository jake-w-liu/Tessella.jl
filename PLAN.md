...
snapshots, and the entity name. Allocation counters remain monotonic. Boolean operand
tags remain operation-time provenance rather than live references. This bounded model
...
also removed from names and Physical memberships; empty groups and names, target
embeddings, affected periodic relations, primitive encodings, Boolean-result
snapshots, and construction loops made invalid by boundary recursion are cleaned.
