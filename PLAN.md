...
Gmsh 4.15.2 defines no Trihedron integration rule. Higher-order/non-simplex
function spaces, entity-filtered orientation/key results, and nondefault task
partitioning also remain pending.
