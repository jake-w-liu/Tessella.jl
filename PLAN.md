...
and 12- or 16-entry `Affine` transforms plus constant entity ranges. Planar periodic
...
periodic volume entities, dynamic tag allocators, or periodic list variables. The
