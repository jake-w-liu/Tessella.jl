...
successful update. The planar surface path conservatively uses the minimum selected
Point constraint uniformly; spatial interpolation, hidden primitive Points,
topology-derived selectors, nonpositive values, and Gmsh's silent missing-Point
...
geometry-expression, numeric-list, Point-mesh-size, dynamic-tag/`SetMaxTag`, uniform-refinement,
