...
│   ├── MeshFunctionSpaces fixed-family order-one nodal and simplex H1/Whitney
│   │                     bases, orientations, and global node/edge keys
...
Reference function-space queries provide explicit-order-one Lagrange functions and
gradients for every fixed-node Point, Line, Triangle, Quadrangle, Tetrahedron,
Hexahedron, Prism, and Pyramid type. Unqualified isoparametric/Lagrange aliases
cover Point and first-order types 1--7. Order-one hierarchical H1 functions and
gradients and lowest-order H(curl) functions and curls cover types 1, 2, and 4.
...
Gmsh 4.15.2 defines no Trihedron integration rule. Arbitrary interpolation orders,
non-simplex hierarchical spaces, Trihedron bases, entity-filtered orientation/key
