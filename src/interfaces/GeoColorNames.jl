# Gmsh 4.15.2 X11 color-name table (src/common/Colors.h `ColorString`),
# generated verbatim — RGBA components in 0:255.
const _GEO_COLOR_NAMES = Dict{String,NTuple{4,Int}}(
