...
include("core/MeshFunctionSpaces.jl") # P5: fixed-family nodal and simplex hierarchical bases
...
using .Model: GeoModel, add_point!, set_point_mesh_size!, add_line!, add_curve_loop!, add_plane_surface!,
