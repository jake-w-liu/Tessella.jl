...
transfinite curve-law and three-sided transfinite differentials as mandatory
bounds-checked children. Missing or wrong-version Gmsh and differential failures make
the aggregate command fail. See
